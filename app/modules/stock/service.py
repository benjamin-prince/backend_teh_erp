...
SUBCATEGORIES: dict[str, list[str]] = {
    "electronics": ["laptop", "desktop", "smartphone", "tablet", "printer", "tv_display", "camera", "audio", "gaming", "component", "other"],
    ...
    "accessories": ["bag", "case", "mouse", "keyboard", "monitor_stand", "hub", "adapter", "other"],
