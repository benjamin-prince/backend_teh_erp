...
class Customer(Base):
    ...
    # ── Identity ──────────────────────────────────────────────────────────────
    entity_type      = Column(String(20), default="person")   # person | company
    first_name       = Column(String(100), nullable=False)
    last_name        = Column(String(100), nullable=False)
    company_name     = Column(String(200), nullable=True)

    # ── Legal / Company info ──────────────────────────────────────────────────
    nui              = Column(String(50),  nullable=True)
    bp               = Column(String(100), nullable=True)
    ...
    kyc_level        = Column(String(30),  nullable=False, default="basic")
    is_vip           = Column(Boolean,     default=False)
    vip_granted_by   = Column(Integer,     nullable=True)
    vip_granted_at   = Column(DateTime,    nullable=True)
    ...
    # ── Invoice bypass flag (Rule A) ──────────────────────────────────────────
    can_invoice_without_br = Column(Boolean, default=False)
    invoice_flag_reason    = Column(Text,    nullable=True)
    invoice_flag_set_by    = Column(Integer, nullable=True)
    invoice_flag_set_at    = Column(DateTime, nullable=True)
    ...
    @property
    def full_name(self) -> str:
        if self.company_name and self.entity_type == "company":
